...
30/8/22
'''
from pydrive2.drive import GoogleDrive # import google drive module from pydrive
from pydrive2.auth import GoogleAuth # import google authentication from pydrive
...
def zipcheck(): # define function
    ...
    for file in filelist: # for each file in filelist
        ...
        if extension == 'ISO': # if its a zip file
            foundfile = file # append to a foundfile variable
